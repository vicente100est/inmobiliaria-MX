      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="ci_AdmAvisos.php">APROBACION DE AVISO</a></li>
            <li><a href="ci_AdmCitas.php">DETALLE DE CITAS</a></li>
            <li><a href="ci_AdmConsultas.php">SOLICITUDES DE AVISO</a></li>
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="ci_AvisoRepor.php">INMUEBLES</a></li>
