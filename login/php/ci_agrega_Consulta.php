...
//switch($proceso){
//	case 'Registro':
		mysqli_query($conexion,"INSERT INTO solicitud (fechasol,nombresol,emailsol,celusol,codpropi,observsol,cancelo,codigosol)VALUES
		 ('$fecha','$nom','$emma','$cel','$codx','$observ','NO','$codigo')");
