...
$destino2="login/fotos/".$foto; // AUMENTA LA X DEBERIA SER UN NUMERO CORRELATIVO
...
mysqli_query($conexion,"UPDATE propiedades SET fotoprop = '$destino',fotoprop2='$destino2' WHERE codpropi = '$id'");

	echo '<Script language=javascript> 
	alert("LA IMAGEN FUE SUBIDA CORRECTAMENTE...")
	self:location="ci_AdmAvisos.php"	
	</script>';
 ?>
